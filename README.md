...
```
In both examples, the selection conditions are applied in order, form the most inner ones (query1 selection predicate first) to the outer ones (query2 selection predicate last). 
